...
import image from "../../assets/Images/bannar.jpg";
  ...
  return (
    <div className="width mt-0">
      <Swiper
        ...
        className="mySwiper"
      >
        <SwiperSlide className="relative bg-blue-400 h-[70vh]">
          ...
          <div className="flex flex-col md:flex-row justify-between">
            <div className=" text-white px-4 py-8 flex flex-col justify-center ml-0 md:ml-20 gap-10 items-center">
              <div className="text-center border-2 h-24 rounded px-6 relative">
                <div className="">
            ...
            <div className="w-full md:w-1/2 md:h-[70vh]">
              <img className="md:h-[70vh] " src={image} alt="bannar image" />
            </div>
          </div>
